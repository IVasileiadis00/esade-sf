...
csv_tag(ax, 10, 18.95, "master_dataset_DATE.csv  (57 companies × 84 columns)")
...
box(ax, 10, 8.72, 7.0, 0.65,
    "Agent 11 — Portfolio Construction",
    "ESG floor exclusions · composite score (60% ESG + 40% Sharpe) · top 20 · weights capped 10%",
    fc=C_PURPLE_LT, ec=C_PURPLE, text_color=C_PURPLE, fontsize=9.5)
arrow(ax, 10, 8.39, 10, 7.99, color=C_GREY)
csv_tag(ax, 10, 7.79, "final_portfolio_DATE.csv  (20 holdings)   +   exclusions.csv  (19 excluded)")
...
box(ax, 10, 6.82, 6.5, 0.65,
    "Agent 12 — Human Review",
    "Override log (ADD / REMOVE / ADJUST_WEIGHT)  ·  AI Use Statement",
...
csv_tag(ax, 10, 3.99, "portfolio_weights.png  +  esg_comparison.png  +  risk_return_chart.png")
